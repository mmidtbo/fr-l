...
import { formatRupiah, formatDate, STATUS_LABELS } from "@/lib/types";
import { Printer, CheckCircle, WashingMachine } from "lucide-react";
...
export function OrderReceipt({ order }: OrderReceiptProps) {
  ...
  return (
    <Card className="mx-auto w-full max-w-sm">
      <CardHeader>
        <CardTitle>Gresik Laundry</CardTitle>
        <CardDescription>Jl. Raya Gresik, Gresik, Jawa Timur</CardDescription>
        <CardDescription>Telp: 0812-3456-7890</CardDescription>
      </CardHeader>
      <CardContent className="-mb-(--card-spacing)">
        ...
        >
          ...
          <div className="mt-3 text-center text-xs text-muted-foreground space-y-1">
            ...
            <p>
              Pakaian yang tidak diambil lebih dari 30 hari menjadi tanggung
              jawab pelanggan.
            </p>
